...
export interface ApiArticuloArticulo extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Art\u00EDculos, noticias, notas del presidente y debates';
...
export interface ApiAutorAutor extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Autores de art\u00EDculos y programas';
    displayName: 'Autor';
    pluralName: 'autores';
    singularName: 'autor';
  };
...
export interface ApiDebateDebate extends Struct.CollectionTypeSchema {
  collectionName: 'debates';
  info: {
    description: 'Debate activo en la secci\u00F3n Articulando';
    displayName: 'Debate';
    pluralName: 'debates';
    singularName: 'debate';
  };
  ...
  attributes: {
    ...
    articulo_relacionado: Schema.Attribute.Relation<
      'manyToOne',
      'api::articulo.articulo'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    fecha_cierre: Schema.Attribute.Date;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::debate.debate'
...
export interface ApiEjeFormativoEjeFormativo
  extends Struct.CollectionTypeSchema {
  collectionName: 'eje_formativos';
  info: {
    description: 'Ejes formativos del carrusel del Home';
    displayName: 'Eje Formativo';
    pluralName: 'eje-formativos';
    singularName: 'eje-formativo';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiHeroConfigHeroConfig extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Configuraci\u00F3n del hero del Home \u2014 video/imagen, t\u00EDtulo, bot\u00F3n y estad\u00EDsticas';
  ...
  attributes: {
    archivo_media: Schema.Attribute.Media<'images' | 'videos'>;
    boton_texto: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Conocer m\u00E1s'>;
    boton_url: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'/programas'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    programa_destacado: Schema.Attribute.Relation<
      'manyToOne',
      'api::programa.programa'
    >;
    publishedAt: Schema.Attribute.DateTime;
    stat_1: Schema.Attribute.String;
    stat_2: Schema.Attribute.String;
    stat_3: Schema.Attribute.String;
    subtitulo: Schema.Attribute.Text;
    tipo_media: Schema.Attribute.Enumeration<['video', 'imagen']> &
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::eje-formativo.eje-formativo': ApiEjeFormativoEjeFormativo;
