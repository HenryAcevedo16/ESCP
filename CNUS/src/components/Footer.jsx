...
export default function Footer() {
  return (
    <footer className="bg-[#0B1426] text-white py-16 mt-20 laptop:mt-0">
      <div className="max-w-[1680px] mx-auto px-4 tablet:px-7.5 laptop:px-20 desktop:px-6 grid grid-cols-1 tablet:grid-cols-12 gap-10 tablet:gap-4 laptop:gap-16">
        ...
        <div className="tablet:col-span-4 laptop:col-span-5 space-y-4 laptop:space-y-6">
          ...
          <p className="text-[10px] laptop:text-sm text-gray-300 leading-relaxed max-w-md">
        ...
        <div className="tablet:col-span-2 laptop:col-span-2">
          <h4 className="font-bold text-[13px] laptop:text-lg mb-4 laptop:mb-6 whitespace-nowrap">Mapa del sitio</h4>
          <ul className="space-y-2 laptop:space-y-4 text-[11px] laptop:text-sm text-gray-300">
        ...
        <div className="tablet:col-span-4 laptop:col-span-3">
          <h4 className="font-bold text-[13px] laptop:text-lg mb-4 laptop:mb-6">Programas</h4>
          <div className="grid grid-cols-2 gap-2 laptop:gap-4 text-[11px] laptop:text-sm text-gray-300">
        ...
        <div className="tablet:col-span-2 laptop:col-span-2">
          <h4 className="font-bold text-[13px] laptop:text-lg mb-4 laptop:mb-6">Contactanos</h4>
          <ul className="space-y-2 laptop:space-y-4 text-[11px] laptop:text-sm text-gray-300">
      ...
      <div className="max-w-[1680px] mx-auto px-4 tablet:px-7.5 tablet:gap-5 laptop:px-20 desktop:px-6 mt-16 pt-8 border-t border-gray-600 flex flex-col tablet:flex-row items-center justify-between text-[11px] tablet:text-xs text-gray-400">
