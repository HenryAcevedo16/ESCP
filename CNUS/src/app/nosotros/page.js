    ...
    <main className="w-full bg-white">
      ...
      <section className="relative w-full h-[280px] md:h-[450px] overflow-hidden mb-[200px]">
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center pb-20">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-light tracking-wide text-white text-center mt-4 max-w-4xl">
            Sobre Nosotros
          </h1>
        </div>
      </section>
      ...
      <section className="max-w-[1200px] mx-auto px-6 mb-16 md:mb-24">
        <div className="bg-[#0045A5] rounded-[32px] md:rounded-[40px] p-8 md:p-16 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contacto" className="bg-white text-[#0045A5] font-semibold px-10 py-4 rounded-full hover:bg-blue-50 transition text-center">
              Contáctanos
            </Link>
            <Link href="/programas" className="bg-transparent border border-white text-white font-semibold px-10 py-4 rounded-full hover:bg-white/10 transition text-center">
              Ver Programas
            </Link>
          </div>
        </div>
