...
export default function NosotrosPage() {
  return (
    <main className="w-full bg-white">
      ...
      {/* ─── BANNER ─────────────────────────────────────────────── */}
      <section className="relative w-full h-[500px] overflow-hidden mb-[80px]">
        <div
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center pb-20">
          <p className="text-blue-300 uppercase tracking-widest text-sm font-semibold mb-4">Quiénes somos</p>
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white text-center mt-4 max-w-4xl leading-tight">
            Escuela CNUS de<br/>Sindicalismo Sociopolítico
          </h1>
        </div>
      </section>
      ...
      <section className="max-w-[1200px] mx-auto px-6 mb-28">
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2">
            <span className="inline-block bg-blue-100 text-[#0045A5] text-sm font-semibold px-4 py-2 rounded-full mb-6">
          ...
          <div className="lg:w-1/2">
            <div className="bg-[#0B1426] rounded-[40px] p-12 text-white grid grid-cols-2 gap-8">
      ...
      {/* ─── MISIÓN Y VISIÓN ────────────────────────────────────── */}
      <section className="bg-gray-50 py-24 mb-28">
        <div className="max-w-[1200px] mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Misión */}
          <div className="bg-white rounded-[32px] p-10 shadow-sm border border-gray-100 flex flex-col gap-6">
          ...
          {/* Visión */}
          <div className="bg-[#0045A5] rounded-[32px] p-10 flex flex-col gap-6">
      ...
      <section className="max-w-[1200px] mx-auto px-6 mb-28">
        <div className="text-center mb-16">
          <span className="inline-block bg-blue-100 text-[#0045A5] text-sm font-semibold px-4 py-2 rounded-full mb-4">
            Lo que nos guía
          </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {valores.map(({ icono: Icono, titulo, descripcion }) => (
            <div
              key={titulo}
              className="border border-gray-200 rounded-[28px] p-8 hover:border-[#0045A5] hover:shadow-md transition-all duration-300 group"
            >
      ...
      <section className="bg-[#0B1426] py-24 mb-28">
        <div className="max-w-[1200px] mx-auto px-6 flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
            <span className="inline-block bg-blue-900 text-blue-300 text-sm font-semibold px-4 py-2 rounded-full mb-6">
              Nuestro enfoque
            </span>
      ...
      <section className="max-w-[1200px] mx-auto px-6 mb-24">
        <div className="bg-[#0045A5] rounded-[40px] p-12 md:p-16 text-center text-white">
