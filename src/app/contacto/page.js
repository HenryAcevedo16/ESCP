...
export default function ContactoPage() {
  return (
    <main className="w-full bg-white">
      {/* Banner Section */}
      <section className="relative w-full h-[500px] overflow-hidden mb-[100px]">
        <div 
        ...
        <div className="relative z-10 h-full flex flex-col items-center justify-center pb-20">
          <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold text-white text-center mt-20">
            Contáctanos
          </h1>
        </div>
      </section>
      ...
      <section className="max-w-[1680px] mx-auto px-6 py-24 flex flex-col lg:flex-row gap-[24px]">
        
        {/* Left Side: Contact Form (Dark Blue Card) */}
        <div className="w-[828px] h-[942px] shrink-0 bg-[#0B1426] rounded-[40px] p-10 md:p-14 text-white flex flex-col items-center justify-center">
          <div className="w-full max-w-[697px] flex flex-col">
            <h2 className="text-4xl font-bold mb-15">Tu formación comienza con una conversación</h2>
            ...
            <form className="flex flex-col gap-[24px]">
              <div className="flex flex-col md:flex-row gap-[15px]">
                <div className="flex flex-col gap-[15px]">
                  ...
                  <input 
                    ...
                    className="w-[336px] h-[79px] px-5 rounded-full text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                    required
                  />
                </div>
                <div className="flex flex-col gap-[15px]">
              ...
              <div className="flex flex-col gap-[15px]">
                ...
                <input 
                  ...
                  className="w-[697px] h-[79px] px-5 rounded-full text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                  required
                />
              </div>
              ...
              <div className="flex flex-col gap-[15px]">
                ...
                <textarea 
                  ...
                  className="w-[697px] h-[190px] p-5 rounded-[32px] text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
                  required
                ></textarea>
              </div>
              ...
              <button 
                type="submit" 
                className="w-[697px] h-[89px] bg-[#0045A5] hover:bg-blue-700 text-white font-semibold rounded-full transition"
              >
                Enviar
              </button>
            </form>
        ...
        <div className="w-full lg:w-1/2 flex flex-col pt-4">
          ...
          {/* Map Area */}
          <div className="w-full flex-grow bg-gray-200 rounded-[32px] overflow-hidden min-h-[300px]">
            <iframe 
