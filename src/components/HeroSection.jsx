  ...
  return (
    <section className="relative w-full bg-white">
      ...
      <div className="relative w-full h-[925px] bg-slate-800 overflow-hidden">
        ...
        {/* Hero Content */}
        <div className="relative z-10 max-w-[1400px] mx-auto h-full flex flex-col items-center justify-center text-center px-6 pt-10 pb-20">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight max-w-[1300px] mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 mt-4">
            <button className="bg-primary hover:bg-primary-dark text-white w-[260px] h-[80px] text-[24px] rounded-full font-semibold transition flex items-center justify-center">
              Ver Programas
            </button>
            <button className="bg-transparent border border-white hover:bg-white/10 text-white w-[260px] h-[80px] text-[24px] rounded-full font-semibold transition flex items-center justify-center">
              Conócenos
            </button>
          </div>
        </div>
      ...
      >
        ...
        <div className="text-center w-full">
          <p className="font-bold text-gray-900 md:text-lg">10 ejes formativos</p>
        </div>
        <div className="w-px h-12 bg-gray-200 hidden md:block"></div>
        <div className="text-center w-full">
          <p className="font-bold text-gray-900 md:text-lg">8 modalidades</p>
        </div>
        <div className="w-px h-12 bg-gray-200 hidden md:block"></div>
        <div className="text-center w-full">
          <p className="font-bold text-gray-900 md:text-lg">14 líneas sectoriales</p>
        </div>
      </div>
    </section>
  );
