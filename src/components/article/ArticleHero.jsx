export default function ArticleHero({ category, title, imageUrl }) {
  return (
    <div className="relative w-full h-[60vh] min-h-[400px] md:min-h-[500px] xl:min-h-[600px] mt-[116px]">
      {/* Background Image */}
      <div 
      ...
      <div className="relative h-full flex flex-col justify-end pb-16 px-6 md:px-[118px] max-w-[1920px] mx-auto z-10 w-full">
        <div className="w-full max-w-[1680px] h-[192px] flex flex-col justify-end">
