...
export default function CursosSection() {
  ...
  return (
    <section className="w-full h-[902px] bg-[#f8f9fa] py-20">
      <div className="max-w-[1728px] mx-auto px-6">
        ...
        <div className="flex flex-wrap justify-center gap-[24px]">
          {cursos.map((curso) => (
            <div key={curso.id} className="w-[402px] h-[604px] shrink-0 bg-white rounded-3xl p-4 flex flex-col border border-transparent hover:border-primary hover:shadow-lg transition-all duration-300 cursor-pointer">
              {/* Image Placeholder */}
              <div className="w-[364px] h-[256px] mx-auto bg-gray-200 rounded-2xl mb-6 shrink-0"></div>
